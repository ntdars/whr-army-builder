...
const WOOD_ELVES_MAGIC_ITEMS = [
  ...
  { id: "mi-antlertotem", name: "Antler Totem", cost: 15, cat: "arcane", desc: "Wizard using Amber or Jade may choose spells.", restrictedTo: [{ tags: ["wizard"] }] },
...
const EMPIRE_MAGIC_ITEMS = [
  ...
  { id: "em-acolytes", name: "Acolytes", cost: 10, cat: "arcane", desc: "A foot Light wizard may be accompanied by acolytes, letting him cast one Light spell per phase for one less power card. Not a true magic item (can't be nullified), but costs a magic item slot.", restrictedTo: [{ tags: ["wizard"] }] },
  { id: "em-antlertotem", name: "Antler Totem", cost: 15, cat: "arcane", desc: "Wizard using Amber or Jade magic may choose spells.", restrictedTo: [{ tags: ["wizard"] }] },
...
const EMPIRE = {
  ...
  regiments: [
    {
      ...
      note: "State Troops with halberds.", baseGear: ["Halberds"],
      options: [
        { id: "armour", group: null, label: "Light armour", cost: 0.5, per: "model" },
    ...
    },
    {
      ...
      note: "State Troops with spears.", baseGear: ["Spears"],
      options: [
        { id: "armour", group: null, label: "Light armour", cost: 0.5, per: "model" },
        { id: "shield", group: null, label: "Shields", cost: 0.5, per: "model" },
      ],
    ...
    },
    {
      ...
      note: "State Troops with pikes.", baseGear: ["Pikes"],
      options: [
        { id: "armour", group: null, label: "Light armour", cost: 0.5, per: "model" },
      ],
      champion: { name: "Empire Champion", baseCost: 20, magicItemSlots: 1, stat: "Empire Champion" },
    },
    {
      ...
      note: "State Troops with double handed weapons.", baseGear: ["Double handed weapons"],
      options: [
        { id: "armour", group: null, label: "Light armour", cost: 0.5, per: "model" },
      ],
      champion: { name: "Empire Champion", baseCost: 20, magicItemSlots: 1, stat: "Empire Champion" },
    },
    {
      ...
      note: "Swordsmen with shields.", baseGear: ["Shields"],
      options: [
        { id: "armour", group: null, label: "Light armour", cost: 0.5, per: "model" },
      ],
    ...
    },
    {
      ...
      note: "State Troops with longbows. May skirmish (loses standard bearer while skirmishing).", baseGear: ["Longbows"],
      options: [
        { id: "armour", group: null, label: "Light armour", cost: 0.5, per: "model" },
      ],
      champion: { name: "Empire Champion", baseCost: 20, magicItemSlots: 1, stat: "Empire Champion" },
    },
    {
      ...
      note: "State Troops with crossbows.", baseGear: ["Crossbows"],
      options: [
        { id: "armour", group: null, label: "Light armour", cost: 0.5, per: "model" },
      ],
      champion: { name: "Empire Champion", baseCost: 20, magicItemSlots: 1, stat: "Empire Champion" },
    },
    {
      ...
      note: "State Troops with handguns.", baseGear: ["Hand guns"],
      options: [
        { id: "armour", group: null, label: "Light armour", cost: 0.5, per: "model" },
      ],
      champion: { name: "Empire Champion", baseCost: 20, magicItemSlots: 1, stat: "Empire Champion" },
    },
    {
      ...
      note: "State Troops in light armour with two pistols, on Normal Horses. Fast cavalry. May skirmish.", baseGear: ["Two pistols"],
    ...
    },
    {
      ...
      note: "State Troops in light armour with repeating handguns, on barded Normal Horses.", baseGear: ["Repeating handguns"],
      champion: { name: "Empire Captain", baseCost: 20, magicItemSlots: 1, stat: "Empire Captain" },
    },
    {
      ...
      note: "Knights with barded warhorses, full plate armour, and double handed weapons.", baseGear: ["Double handed weapons"],
      knightGroup: "whiteWolf",
      champion: { name: "Empire Captain", baseCost: 30, magicItemSlots: 1, stat: "Empire Captain" },
    },
    {
      id: "teutogen", name: "Teutogen Foot Knights", perModel: 13, minSize: 5, stat: "Knight (Empire)", command: "standard",
      note: "Knights with full plate armour and double handed weapons.", baseGear: ["Double handed weapons"],
    ...
    },
    {
      ...
      note: "Knights with barded warhorses, full plate armour, shields, and lances.", baseGear: ["Lances", "Shields"],
      knightGroup: "panther",
      champion: { name: "Empire Captain", baseCost: 30, magicItemSlots: 1, stat: "Empire Captain" },
    },
    {
      ...
      note: "Knights with barded warhorses, full plate armour, shields, and lances. Can alternatively represent a lesser Knightly Order of your own design.", baseGear: ["Lances", "Shields"],
    ...
    },
    {
      ...
      note: "Knights with full plate armour and shields.", baseGear: ["Shields"],
    ...
    },
    {
      ...
      note: "Warhorses, light armour, shields, and lances. Fast cavalry.", baseGear: ["Lances", "Shields"],
      options: [
    ...
    },
    {
      ...
      note: "Fighters with bows, double handed weapons, and light armour.", baseGear: ["Bows", "Double handed weapons"],
    ...
    },
    {
      ...
      note: "Bows, on Normal Horses. Fast cavalry. May skirmish.", baseGear: ["Bows"],
      champion: { name: "Fighter Champion", baseCost: 20, magicItemSlots: 1, stat: "Fighter Champion" },
    },
    {
      id: "freecompany", name: "Free Company", perModel: 5.5, minSize: 5, stat: "Fighter", command: "standard", auxiliary: true,
      note: "Armed with various weapons that function as additional hand weapons.", baseGear: ["Additional hand weapons"],
      options: [
        { id: "armour", group: null, label: "Light armour", cost: 0.5, per: "model" },
    ...
    },
    {
      ...
      note: "Bows. May skirmish. Foresters — move through woods without penalty regardless.", baseGear: ["Bows"],
    ...
    },
    {
      ...
      note: "Light armour and shields. Foresters — move through woods without penalty regardless.", baseGear: ["Shields"],
      options: [
  ...
  detachmentTypes: [
    { id: "halberdiers", name: "Halberdiers (detachment)", perModel: 5, stat: "State Trooper", baseGear: ["Halberds"] },
    { id: "spearmen", name: "Spearmen (detachment)", perModel: 5, stat: "State Trooper", baseGear: ["Spears"] },
    { id: "pikemen", name: "Pikemen (detachment)", perModel: 8, stat: "State Trooper", baseGear: ["Pikes"] },
    { id: "greatswords", name: "Greatswords (detachment)", perModel: 6, stat: "State Trooper", baseGear: ["Double handed weapons"] },
    { id: "swordsmen", name: "Swordsmen (detachment)", perModel: 5.5, stat: "Swordsman", baseGear: ["Shields"] },
    { id: "freecompany", name: "Free Company, trained (detachment)", perModel: 6, stat: "Fighter", baseGear: ["Additional hand weapons"] },
    { id: "crossbowmen", name: "Crossbowmen (detachment)", perModel: 9, stat: "State Trooper", baseGear: ["Crossbows"] },
    { id: "handgunners", name: "Handgunners (detachment)", perModel: 9, stat: "State Trooper", baseGear: ["Hand guns"] },
    { id: "archers", name: "Archers (detachment)", perModel: 7, stat: "State Trooper", baseGear: ["Longbows"] },
  ],
  chariotsMonsters: [
    {
  ...
  specialCharacters: [
    ...
    { id: "karlfranz", name: "The Emperor Karl Franz", cost: 260, stat: "The Emperor Karl Franz", role: "Lord (must be general)",
      ...
      mounts: [
        { id: "warhorse", name: "Barded Warhorse", cost: 20, stat: "Warhorse" },
        { id: "griffon", name: "Griffon", cost: 175, stat: "Griffon" },
      ] },
...
const HIGH_ELF_MAGIC_ITEMS = [
  ...
  { id: "he-cloakofstars", name: "Cloak of Stars", cost: 25, cat: "arcane", desc: "Hits against the bearer have S reduced by 2. First spell cast directly at the bearer/regiment is auto-dispelled unless Total Power.", restrictedTo: [{ tags: ["wizard"] }] },
  { id: "he-warcrown", name: "War Crown of Saphery", cost: 50, cat: "arcane", desc: "+1 magic level. Doesn't increase the number of items the bearer can carry.", restrictedTo: [{ tags: ["wizard"] }] },
  { id: "he-bookphoenix", name: "Book of the Phoenix", cost: 250, cat: "arcane", desc: "Once per magic phase, cast a spell without using power cards.", restrictedTo: [{ tags: ["wizard"] }] },
...
const BRETONNIA_MAGIC_ITEMS = [
  ...
  { id: "br-bufoshexscroll", name: "Bufo's Hex Scroll", cost: 100, cat: "arcane", desc: "One use. Any spell cast at the bearer or his regiment is dispelled, even with Total Power, and the caster is turned into a frog (counts as slain). Returns on his own table edge if Drain Magic is cast; Slann Mage Priests are unaffected.", restrictedTo: [{ tags: ["wizard"] }] },
...
const BRETONNIA = {
  ...
  specialCharacters: [
    ...
    { id: "tancred", name: "Tancred, Duc de Quenelles", cost: 200, stat: "Tancred, Duc de Quenelles", role: "Knightly Lord",
      ...
      mounts: [
        { id: "warhorse", name: "Barded Warhorse", cost: 75, stat: "Warhorse" },
        { id: "pegasus", name: "Pegasus", cost: 150, stat: "Pegasus" },
        { id: "hippogriff", name: "Hippogriff", cost: 300, stat: "Hippogriff" },
      ] },
...
const UNDEAD_MAGIC_ITEMS = [
  ...
  { id: "und-swordunholy", name: "Sword of Unholy Power", cost: 25, cat: "arcane", desc: "Also a magic weapon. A winds of magic card is generated each time the bearer kills an enemy model with this blade — dealt to the bearer next magic phase, usable only by him.", restrictedTo: [{ tags: ["wizard"] }] },
  ...
  { id: "und-staffdamnation", name: "Staff of Damnation", cost: 50, cat: "arcane", desc: "Bound Spell. May cast Vanhel's Danse Macabre for free, up to three times per game, once per magic phase.", restrictedTo: [{ tags: ["wizard"] }] },
...
const LIZARDMEN_MAGIC_ITEMS = [
  ...
  { id: "liz-amuletitza", name: "Amulet of Itza", cost: 40, cat: "arcane", desc: "Natural dispel 4+. A successful dispel deals a magical S4 hit to the unfortunate caster (or bearer of the relevant bound item).", restrictedTo: [{ tags: ["wizard"] }] },
  { id: "liz-itxigrubs", name: "The Itxi Grubs", cost: 40, cat: "arcane", desc: "If eaten when magic cards are dealt, the bearer gains 1D6+1 magic cards only he can use. One use only.", restrictedTo: [{ tags: ["wizard"] }] },
  { id: "liz-plaquetepec", name: "The Plaque of Tepec", cost: 50, cat: "arcane", desc: "Works as a Dispel Magic Scroll. After use, both players roll 1D6 — if the owner rolls higher, the spell is also destroyed. One use only.", restrictedTo: [{ tags: ["wizard"] }] },
...
const SLANN_MAGIC_ITEMS = [
  { id: "sla-amuletitza", name: "Amulet of Itza", cost: 40, cat: "arcane", desc: "Natural dispel 4+. A successful dispel deals a magical S4 hit to the unfortunate caster (or bearer of the relevant bound item).", restrictedTo: [{ tags: ["wizard"] }] },
  { id: "sla-itxigrubs", name: "The Itxi Grubs", cost: 40, cat: "arcane", desc: "If eaten when magic cards are dealt, the bearer gains 1D6+1 magic cards only he can use. One use only.", restrictedTo: [{ tags: ["wizard"] }] },
  { id: "sla-plaquetepec", name: "The Plaque of Tepec", cost: 50, cat: "arcane", desc: "Works as a Dispel Magic Scroll. After use, both players roll 1D6 — if the owner rolls higher, the spell is also destroyed. One use only.", restrictedTo: [{ tags: ["wizard"] }] },
...
// Shared fetch/parse logic for changelog.txt — used by both the footer link's presence check
// (so it only shows up on SetupScreen if the file actually exists) and the full ChangelogScreen
// page it links to. Format is deliberately dead simple: blocks separated by a blank line, the
// first line of each block is its heading (typically a date), every line after that in the
// block becomes its own bullet. No markdown, no special syntax — this is kept as a separate
// plain-text file specifically so it can be hand-edited on GitHub without touching App.jsx.
...
function ChangelogScreen({ onBack }) {
  const { entries, failed } = useChangelog();
  return (
    <div className="whr-content" style={{ maxWidth: 700, margin: "0 auto", padding: "48px 24px 80px" }}>
      <button className="whr-btn whr-btn-sm" onClick={onBack} style={{ marginBottom: 20 }}>← Barracks</button>
      <h1 className="whr-h1" style={{ fontSize: 38, margin: "0 0 4px" }}>Changelog</h1>
      <div style={{ width: 64, height: 2, background: "var(--gold)", margin: "0 0 28px" }} />
      {failed || (entries && entries.length === 0) ? (
        <p className="whr-serif-italic" style={{ color: "var(--ink-faint)" }}>No changelog yet.</p>
      ) : entries === null ? null : (
        entries.map((e, i) => (
          <div key={i} style={{ marginBottom: 22 }}>
            <div style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 16, color: "var(--ink-soft)", marginBottom: 5 }}>{e.heading}</div>
            {e.items.length > 0 && (
              <ul style={{ margin: 0, paddingLeft: 20, fontSize: 15, color: "var(--ink)", lineHeight: 1.6 }}>
...
function SetupScreen({ onMuster, savedList, onLoad, onDelete, storageError, onOpenChangelog }) {
      ...
      <div style={{ textAlign: "center", marginTop: 48 }}>
        <p className="whr-serif-italic" style={{ fontSize: 14.5, color: "var(--ink-faint)" }}>
          <button type="button" onClick={onOpenChangelog}
            style={{ background: "none", border: "none", cursor: "pointer", padding: 0, font: "inherit", color: "var(--ink-faint)", textDecoration: "underline" }}>
            Changelog
          </button>
    ...
    <div ref={cardRef} className={`whr-card ${selected ? "whr-card-selected" : ""}`}
      ...
      {tags.length > 0 && (
        <div style={{ display: "flex", flexWrap: "wrap", gap: 5, marginTop: 4 }}>
          {tags.map((t, i) => (
            <span key={i} title={mundaneGearDesc(t)} style={{ fontSize: 13, color: "var(--ink-soft)", background: "var(--paper-3)", border: "1px solid var(--line-soft)", borderRadius: 3, padding: "1px 7px" }}>{t}</span>
          ))}
        </div>
      )}
    </div>
...
export default function App() {
  ...
  return (
    <div className="whr-root">
      ...
      {view === "setup" && (
        <SetupScreen onMuster={handleMuster} savedList={savedList} onLoad={handleLoad} onDelete={handleDelete} storageError={storageError} onOpenChangelog={() => setView("changelog")} />
      )}
      {view === "builder" && roster && (
      ...
      {view === "changelog" && (
        <ChangelogScreen onBack={() => setView("setup")} />
      )}
    </div>
  );
}
